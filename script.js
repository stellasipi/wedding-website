...
const translations = {
    hu: {
        ...
        accommodation_desc: 'Éjfél után pedig biztosítunk ingyenes sofőrszolgáltatást a helyszín és Kecskemét között, ezért érdemes Kecskeméten szállást foglalni.',
        ...
        form_driver: 'Igénybe vennéd a sofőrszolgáltatást a helyszín és Kecskemét között? *',
        driver_yes: 'Igen',
        driver_no: 'Nem',
    ...
    en: {
        ...
        accommodation_desc: 'After midnight, we provide a free driver service between the venue and Kecskemét, so we recommend booking accommodation in Kecskemét.',
        ...
        form_driver: 'Would you like to use the driver service between the venue and Kecskemét? *',
        driver_yes: 'Yes',
        driver_no: 'No',
